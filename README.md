...
![Rook_in_Maze](rook_in_maze.png?raw=true "Title")
...
When the player reaches the goal point, the application should generate a new maze and the model starts over.
